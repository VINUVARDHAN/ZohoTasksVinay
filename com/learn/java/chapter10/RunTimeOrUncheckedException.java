...
public class RunTimeOrUncheckedException {
	public static void main(String args[])
	{
		...
		//     **** NOTE ****
		/**
		 * We can also replace the exception with parent class exception
		 * example for arithmetic ,null, number formula and array all these are
		 * child of exception class Runtime Exception you can replace with that
		 * 
