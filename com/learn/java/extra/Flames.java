...
public class Flames {
	...
	public static void printingRelationship(char value) {
		...
		case 'f':
			...
			break;
		case 'l':
			System.out.print("are lovers");
			break;
		case 'a':
			System.out.print("have just affection");
			break;
		case 'm':
			System.out.print("will get marriage");
			break;
		case 'e':
			System.out.print("are enemies");
			break;
		case 's':
			System.out.print("are siblings");
			break;
		}
	}
